...
// ─────────────────────────────────────────────
// Frontend users ke liye: Register, Login, Get Profile, Update Profile, Change Password
...
// ══════════════════════════════════════════════════════════════
//  GET /api/users/me        (protected — JWT middleware chahiye)
// ══════════════════════════════════════════════════════════════
...
// ✅ Fixed: now also handles email update from frontend
// ══════════════════════════════════════════════════════════════
...
// ✅ New: this was called in frontend but missing from backend
// ══════════════════════════════════════════════════════════════
